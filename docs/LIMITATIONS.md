...
## 18. Gestiune membri si RBAC delegat pentru managerul clientului (issue #23)
...
niciun `organization_admin` activ (`membership_service._assert_not_last_admin`)
-- ar bloca administrarea ulterioara a membrilor/statiilor pentru toata
